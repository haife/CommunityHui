...
import com.hyphenate.easeui.widget.presenter.EyeChatCustomMessagePresenter;
...
public class EaseMessageAdapter extends BaseAdapter {
    ...
    //自定义消息发送
    private static final int MESSAGE_TYPE_SEND_MESSAGE = 14;
    //自定义消息接收
    private static final int MESSAGE_TYPE_RECEIVE_MESSAGE = 15;
    ...
    public int getItemViewType(int position) {
        ...
        if (message.getType() == EMMessage.Type.TXT) {
            ...
            } else if (message.getBooleanAttribute("custom", false)) {
                return message.direct() == EMMessage.Direct.RECEIVE ? MESSAGE_TYPE_RECEIVE_MESSAGE : MESSAGE_TYPE_SEND_MESSAGE;
            }
        ...
        switch (message.getType()) {
            case TXT:
                if (message.getBooleanAttribute(EaseConstant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)) {
                    ...
                    presenter = new EyeChatCustomMessagePresenter();//自己创建自定义消息
                } else {

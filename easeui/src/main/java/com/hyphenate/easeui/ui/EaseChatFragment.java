...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemStrings = { R.string.attach_take_pic, R.string.attach_picture, R.string.attach_location,R.string.custom_message };
    protected int[] itemdrawables = { R.drawable.ease_chat_takepic_selector, R.drawable.ease_chat_image_selector,
            R.drawable.ease_chat_location_selector,R.drawable.ease_chat_item_file };
    protected int[] itemIds = { ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_LOCATION ,CUSTOM_MESSAGE};
    ...
    class MyItemClickListener implements EaseChatExtendMenu.EaseChatExtendMenuItemClickListener{
        ...
        public void onClick(int itemId, View view) {
            ...
            case CUSTOM_MESSAGE:
                ...
                //增加自己的属性
                message.setAttribute("custom",true);
                message.setAttribute("CUSTOM_MESSAGE","CUSTOM_MESSAGE");

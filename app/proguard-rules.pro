...
-keep public class com.kaiwukj.android.communityhui.app.impl.GlobalConfiguration
...
#  //不混淆某个包所有的类
-keep class com.kaiwukj.android.communityhui.mvp.http.entity.base.** { *; }
#
-keep class com.kaiwukj.android.communityhui.mvp.http.entity.bean** { *; }
-keep class com.kaiwukj.android.communityhui.mvp.http.entity.multi** { *; }
-keep class com.kaiwukj.android.communityhui.mvp.http.entity.request** { *; }
-keep class com.kaiwukj.android.communityhui.mvp.http.entity.result** { *; }
#对含有反射类的处理

 ...
 * @desc 社交动态适配器
 */
public class SocialCircleListAdapter extends BaseQuickAdapter<HRecommendMultiItemEntity, BaseViewHolder> {

    public SocialCircleListAdapter(int layoutResId, @Nullable List<HRecommendMultiItemEntity> data) {

package com.kaiwukj.android.communityhui.mvp.browse;
...
import com.kaiwukj.android.communityhui.mvp.browse.util.JAnimationUtil;
import com.kaiwukj.android.communityhui.mvp.browse.util.JBitmapUtils;
import com.kaiwukj.android.communityhui.mvp.browse.util.JStringUtils;
import com.kaiwukj.android.communityhui.mvp.browse.util.JWindowUtil;
...
public class JBrowseImgActivity extends AppCompatActivity implements
    ...
    public static void start(Context context, ArrayList<String> imgs, int position,ArrayList<JPhotosInfos> infos ){

...
import com.kaiwukj.android.mcas.base.App;
import com.kaiwukj.android.mcas.di.component.AppComponent;
import com.kaiwukj.android.mcas.di.component.DaggerAppComponent;
import com.kaiwukj.android.mcas.di.module.GlobalConfigModule;
import com.kaiwukj.android.mcas.integration.ConfigModule;
import com.kaiwukj.android.mcas.integration.ManifestParser;
 ...
 * @company KW | 开物科技
 * @time 2019/7/1
 * @desc AppDelegate 可以代理 Application 的生命周期,在对应的生命周期,执行对应的逻辑,因为 Java 只能单继承
...
public class AppDelegate implements App, AppLifecycles {
     ...
     *
     * @return AppComponent
     * @see McaUtils#obtainAppComponentFromContext(Context) 可直接获取 {@link AppComponent}
     */
    @NonNull
    @Override

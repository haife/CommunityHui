...
import com.kaiwukj.android.mcas.integration.EventBusManager;
 ...
 * @company KW | 开物科技
 * @time 2019/7/1
 * @desc {@link ActivityDelegate} 默认实现类
 */
public class ActivityDelegateImpl implements ActivityDelegate {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        iActivity.setupActivityComponent(McaUtils.obtainAppComponentFromContext(mActivity));
    }

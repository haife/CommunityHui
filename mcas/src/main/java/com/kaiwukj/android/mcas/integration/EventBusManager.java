...
import static com.kaiwukj.android.mcas.base.Platform.DEPENDENCY_ANDROID_EVENTBUS;
import static com.kaiwukj.android.mcas.base.Platform.DEPENDENCY_EVENTBUS;
 ...
 * @company KW | 开物科技
 * @time 2019/7/1
 * @desc EventBus 的管理类, Arms 核心库并不会依赖某个 EventBus, 如果您想使用 EventBus, 则请在项目中自行依赖对应的 EventBus, 如果不想使用则不依赖

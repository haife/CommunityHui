...
import static com.kaiwukj.android.mcas.base.Platform.DEPENDENCY_SUPPORT_DESIGN;
 ...
 * @company KW | 开物科技
 * @time 2019/7/1
 * @desc 用于管理所有 {@link Activity}, 和在前台的 {@link Activity}
 */
        ...
        Completable.fromAction(new Action() {
            ...
            public void run() throws Exception {
                ...
                if (DEPENDENCY_SUPPORT_DESIGN) {
                    ...
                    McaUtils.makeText(mApplication, message);
                }
            }

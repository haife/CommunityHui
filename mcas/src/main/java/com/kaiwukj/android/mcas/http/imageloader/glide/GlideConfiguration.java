package com.kaiwukj.android.mcas.http.imageloader.glide;
...
import com.kaiwukj.android.mcas.http.OkHttpUrlLoader;
 ...
 * @company KW | 开物科技
 * @time 2019/7/1
 * @desc {@link AppGlideModule} 的默认实现类
...
public class GlideConfiguration extends AppGlideModule {
    ...
    public void applyOptions(@NonNull Context context, @NonNull GlideBuilder builder) {
        final AppComponent appComponent = McaUtils.obtainAppComponentFromContext(context);
    ...
    public void registerComponents(@NonNull Context context, @NonNull Glide glide, @NonNull Registry registry) {
        ...
        AppComponent appComponent = McaUtils.obtainAppComponentFromContext(context);
